...
ALLOWED_HOSTS = env('ALLOWED_HOSTS', default='localhost,127.0.0.1,192.168.100.62').split(',')
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://192.168.100.63:8081",
    "exp://192.168.100.63:8081",
]
...
# MQTT Configuration
MQTT_CONFIG = {
    'HOST': '192.168.100.63',  # Local MQTT broker
    'PORT': 1883,
